...
import { nt as useRouter, s as useRouterState } from "./index.dev-WDfXHCuU.js";
import { S as render, a as ShadowDomTargetContext, m as createSignal, t as DevtoolsOnCloseContext, u as createComponent, v as lazy } from "./context-DmSxegOg-CnJo_s3e.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-CnpwH7La-DFgcpCoK.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) BaseTanStackRouterDevtoolsPanel = this.#Component;
				...
				BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-SWyE65Is-Q9cE5Wsr.js"));
